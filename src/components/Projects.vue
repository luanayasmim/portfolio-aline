...
<template>
    <div class="relative h-screen">
        <div class="bg-[url('./assets/bg.png')] h-[640px] bg-cover bg-center opacity-80">
        ...
        <div class="container mx-auto px-4">
            ...
            <p>Sorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam eu turpis molestie, dictum est a, mattis
        ...
        <div class="container mx-auto px-4">
            <h1 class="text-black text-4xl font-medium">Context</h1>
            <p>Sorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam eu turpis molestie, dictum est a, mattis
                tellus. Sed dignissim, metus nec fringilla accumsan, risus sem sollicitudin lacus, ut interdum tellus
                elit sed risus. Maecenas eget condimentum velit, sit amet feugiat lectus. </p>
        </div>
        ...
        <div class="container mx-auto px-4">
            <h1 class="text-black text-4xl font-medium">Difficulties and learning</h1>
            <p>Sorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam eu turpis molestie, dictum est a, mattis
                tellus. Sed dignissim, metus nec fringilla accumsan, risus sem sollicitudin lacus, ut interdum tellus
                elit sed risus. Maecenas eget condimentum velit, sit amet feugiat lectus. </p>
        </div>
